<template>
  ...
  <header
      data-v-3ae455ef=""
      class="block border-0 border-gray-200 border-solid"
  >
    <div
        data-v-3ae455ef=""
        id="nav"
        class="flex justify-between items-center p-4 mx-auto border-0 border-gray-200 border-solid md:p-0"
        style="max-width: 70rem;"
    >
      <a
          data-v-3ae455ef=""
          href="/"
          class="w-32 text-blue-700 bg-transparent border-0 border-gray-200 border-solid cursor-pointer md:w-48 lg:w-64 hover:no-underline"
      ><svg
          data-v-3ae455ef=""
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 1409.44 406.89"
          class="border-0 border-gray-200 border-solid"
      >
        <rect
            data-v-3ae455ef=""
            x="13.32"
      ...
      <label
          data-v-3ae455ef=""
          for="mainNavTogger"
          class="block mb-0 text-sm font-bold leading-4 text-indigo-300 border-0 border-gray-200 border-solid cursor-default md:hidden"
      ><svg
          data-v-3ae455ef=""
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 50 50"
          class="w-6 h-6 border-0 border-gray-200 border-solid"
          style="fill: currentcolor;"
      >
        <path
            data-v-3ae455ef=""
            d="M25 3c-3.3 0-6 2.7-6 6s2.7 6 6 6 6-2.7 6-6-2.7-6-6-6zm0 16c-3.3 0-6 2.7-6 6s2.7 6 6 6 6-2.7 6-6-2.7-6-6-6zm0 16c-3.3 0-6 2.7-6 6s2.7 6 6 6 6-2.7 6-6-2.7-6-6-6z"
            class="border-0 border-gray-200 border-solid"
        ></path></svg
      ></label>
      <input
          ...
          type="checkbox"
          id="mainNavTogger"
          class="hidden overflow-visible p-0 m-0 w-full text-base text-gray-500 bg-gray-100 rounded border border-gray-300 border-solid appearance-none cursor-default"
    ...
    >
      <h1
          ...
          style="line-height: 55.2px;"
      >
        {{ title }}
      </h1>
      <h2
          class="mx-0 mt-0 mb-4 text-xl font-light leading-9 border-0 border-gray-200 border-solid opacity-75 md:text-3xl"
      >
        {{ subtext }}
      </h2>
    </div>
